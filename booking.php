...
<body>
    <h1>Бронирование номера: <?php echo htmlspecialchars($description); ?></h1>

    <div>
        <img src="<?php echo htmlspecialchars($photo_path); ?>" alt="Фото номера">
    ...
    <form action="process-booking.php" method="POST">
        ...
        <p>ФИО: <?php echo htmlspecialchars($user['username']); ?></p>
